...
import { ChannelConfig, AudioProcessingState } from "../types";
...
export const useAudioProcessing = () => {
  ...
  const getChannelNodeBundles = useCallback(() => ({
    left: {
      ...
      isochronicOscillator: leftIsoOscillatorRef.current,
      isochronicPulseGain: leftIsoPulseGainRef.current,
      isochronicWetGain: leftIsoWetGainRef.current,
      isochronicLfo: leftIsoLfoRef.current,
    },
    right: {
      ...
      isochronicOscillator: rightIsoOscillatorRef.current,
      isochronicPulseGain: rightIsoPulseGainRef.current,
      isochronicWetGain: rightIsoWetGainRef.current,
      isochronicLfo: rightIsoLfoRef.current,
    },
  }), [
    leftGainRef,
    rightGainRef,
